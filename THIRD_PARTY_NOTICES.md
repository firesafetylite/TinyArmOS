...
TinyArmOS includes the following third-party components. Their copyrights remain with their respective authors and contributors.
...
PureDOOM incorporates the Doom engine code originally released by id Software. Its source notices are retained. The integrated TinyArmOS executable is distributed under GPL-2.0-only; see the top-level [LICENSE](LICENSE).
